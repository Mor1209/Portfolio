    ...
    <SectionContainer id='contact' additionalStyles={'flex-col md:pb-20'}>
      ...
      <div className='w-full md:w-[70%] md:grid md:grid-cols-3'>
              ...
              <div className='col-span-6'>
                ...
                <div className='mt-1'>
                  <textarea
                    ...
                    className={`mt-1 block w-full rounded-md shadow-sm sm:text-sm ${
                      messageHasError ? invalidInputClasses : validInputClasses
                    }`}
                  />
                  {messageHasError && (
                    <p className='text-red-500 ml-2'>Please enter a message.</p>
                  )}
                </div>
              </div>
        ...
        <div className='md:col-span-1 mt-5 md:ml-20'>
          ...
          <div className='mt-2 flex md:flex-col md:gap-1 items-center justify-around md:items-start'>
            <div className='md:flex items-center mt-3 md:gap-2'>
              ...
              >
                <h3 className='hidden md:flex font-medium text-zinc-800 dark:text-zinc-100'>
                  GitHub
                </h3>
              </SocialLink>
            </div>
